...
- **LeetCode**：[#3215 Count Triplets With Even Xor Set Bits Ii](https://leetcode.com/problems/count-triplets-with-even-xor-set-bits-ii/)
- **难度**：Medium
...
1 $\le \mathrm{len}(a)$, b.length, c.length $\le 105$
0 <= a[i], b[i], c[i] $\le 109$
