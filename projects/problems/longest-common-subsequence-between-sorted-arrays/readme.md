...
- **LeetCode**：[#1940 Longest Common Subsequence Between Sorted Arrays](https://leetcode.com/problems/longest-common-subsequence-between-sorted-arrays/)
- **难度**：Medium
...
2 $\le \mathrm{len}(arrays)$ $\le 100$
1 <= arrays[i].length $\le 100$
1 <= arrays[i][j] $\le 100$
