...
Here, for every index i where 2 <= i $\le 5$, arr[i-2] <= arr[i].
...
**Output**：2
**Explanation**：
Indices 3 and 5 are the only ones not satisfying arr[i-3] <= arr[i] for 3 <= i $\le 5$.
