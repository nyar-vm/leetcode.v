...
- **LeetCode**：[#2468 Split Message Based On Limit](https://leetcode.com/problems/split-message-based-on-limit/)
- **难度**：Hard
- **标签**：String · Binary Search · Enumeration
...
1 $\le \mathrm{len}(message)$ $\le 104$
