...
- **LeetCode**：[#3400 Maximum Number Of Matching Indices After Right Shifts](https://leetcode.com/problems/maximum-number-of-matching-indices-after-right-shifts/)
- **难度**：Medium
- **标签**：Array · Two Pointers · Simulation
...
1 $\le \mathrm{len}(nums1)$, nums2.length $\le 3000$
