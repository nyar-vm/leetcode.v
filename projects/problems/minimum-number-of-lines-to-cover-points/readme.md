...
- **LeetCode**：[#2152 Minimum Number Of Lines To Cover Points](https://leetcode.com/problems/minimum-number-of-lines-to-cover-points/)
- **难度**：Medium
- **标签**：Bit Manipulation · Geometry · Array · Hash Table · Math · Dynamic Programming · Backtracking · Bitmask
