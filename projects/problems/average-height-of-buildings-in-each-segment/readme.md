...
- **LeetCode**：[#2015 Average Height Of Buildings In Each Segment](https://leetcode.com/problems/average-height-of-buildings-in-each-segment/)
- **难度**：Medium
...
1 $\le \mathrm{len}(buildings)$ $\le 105$
buildings[i].length == 3
0 <= starti < endi $\le 108$
1 <= heighti $\le 105$
