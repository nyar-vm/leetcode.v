...
- **LeetCode**：[#3378 Count Connected Components In Lcm Graph](https://leetcode.com/problems/count-connected-components-in-lcm-graph/)
- **难度**：Hard
- **标签**：Union Find · Array · Hash Table · Math · Number Theory
