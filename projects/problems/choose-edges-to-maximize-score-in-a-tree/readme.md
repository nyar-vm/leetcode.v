...
- **LeetCode**：[#2378 Choose Edges To Maximize Score In A Tree](https://leetcode.com/problems/choose-edges-to-maximize-score-in-a-tree/)
- **难度**：Medium
...
edges[i].length == 2
par0 == weight0 == -1
0 <= pari <= n - 1 for all i $\ge 1$.
pari != i
-106 <= weighti $\le 106$ for all i $\ge 1$.
