...
- **LeetCode**：[#2819 Minimum Relative Loss After Buying Chocolates](https://leetcode.com/problems/minimum-relative-loss-after-buying-chocolates/)
- **难度**：Hard
- **标签**：Array · Binary Search · Prefix Sum · Sorting
...
1 $\le \mathrm{len}(prices)$ == n $\le 105$
1 <= prices[i] $\le 109$
