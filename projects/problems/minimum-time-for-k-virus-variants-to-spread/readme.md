...
- **LeetCode**：[#1956 Minimum Time For K Virus Variants To Spread](https://leetcode.com/problems/minimum-time-for-k-virus-variants-to-spread/)
- **难度**：Hard
- **标签**：Geometry · Array · Math · Binary Search · Enumeration
