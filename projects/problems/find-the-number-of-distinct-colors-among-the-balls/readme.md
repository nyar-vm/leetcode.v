...
- **LeetCode**：[#3160 Find The Number Of Distinct Colors Among The Balls](https://leetcode.com/problems/find-the-number-of-distinct-colors-among-the-balls/)
- **难度**：Medium
...
1 <= limit $\le 109$
1 <= n == queries.length $\le 105$
queries[i].length == 2
0 <= queries[i][0] <= limit
1 <= queries[i][1] $\le 109$
