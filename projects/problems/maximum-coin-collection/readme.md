...
- **LeetCode**：[#3466 Maximum Coin Collection](https://leetcode.com/problems/maximum-coin-collection/)
- **难度**：Medium
...
1 $\le \mathrm{len}(lane1)$ == lane2.length $\le 105$
-109 <= lane1[i], lane2[i] $\le 109$
