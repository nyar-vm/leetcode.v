...
- **LeetCode**：[#3269 Constructing Two Increasing Arrays](https://leetcode.com/problems/constructing-two-increasing-arrays/)
- **难度**：Hard
...
0 $\le \mathrm{len}(nums1)$ $\le 1000$
1 $\le \mathrm{len}(nums2)$ $\le 1000$
