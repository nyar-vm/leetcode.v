...
- **LeetCode**：[#2431 Maximize Total Tastiness Of Purchased Fruits](https://leetcode.com/problems/maximize-total-tastiness-of-purchased-fruits/)
- **难度**：Medium
...
1 <= n $\le 100$
0 <= price[i], tastiness[i], maxAmount $\le 1000$
0 <= maxCoupons $\le 5$
