...
- **LeetCode**：[#555 Split Concatenated Strings](https://leetcode.com/problems/split-concatenated-strings/)
- **难度**：Medium
...
1 $\le \mathrm{len}(strs)$ $\le 1000$
1 <= strs[i].length $\le 1000$
1 <= sum(strs[i].length) $\le 1000$
