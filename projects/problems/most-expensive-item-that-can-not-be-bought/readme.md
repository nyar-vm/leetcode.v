...
- **LeetCode**：[#2979 Most Expensive Item That Can Not Be Bought](https://leetcode.com/problems/most-expensive-item-that-can-not-be-bought/)
- **难度**：Medium
- **标签**：Math · Dynamic Programming · Number Theory
