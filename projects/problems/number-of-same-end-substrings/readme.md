...
- **LeetCode**：[#2955 Number Of Same End Substrings](https://leetcode.com/problems/number-of-same-end-substrings/)
- **难度**：Medium
- **标签**：Array · Hash Table · String · Counting · Prefix Sum
