...
- **LeetCode**：[#3422 Minimum Operations To Make Subarray Elements Equal](https://leetcode.com/problems/minimum-operations-to-make-subarray-elements-equal/)
- **难度**：Medium
- **标签**：Array · Hash Table · Math · Sliding Window · Heap (Priority Queue)
