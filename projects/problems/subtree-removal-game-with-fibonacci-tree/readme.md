...
- **LeetCode**：[#2005 Subtree Removal Game With Fibonacci Tree](https://leetcode.com/problems/subtree-removal-game-with-fibonacci-tree/)
- **难度**：Hard
- **标签**：Tree · Math · Dynamic Programming · Binary Tree · Game Theory
