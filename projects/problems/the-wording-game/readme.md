...
- **LeetCode**：[#2868 The Wording Game](https://leetcode.com/problems/the-wording-game/)
- **难度**：Hard
- **标签**：Greedy · Array · Math · Two Pointers · String · Game Theory
...
1 $\le \mathrm{len}(a)$, b.length $\le 105$
