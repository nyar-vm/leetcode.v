...
- **LeetCode**：[#1714 Sum Of Special Evenly Spaced Elements In Array](https://leetcode.com/problems/sum-of-special-evenly-spaced-elements-in-array/)
- **难度**：Hard
...
1 <= n $\le 5$ * 104
0 <= nums[i] $\le 109$
1 $\le \mathrm{len}(queries)$ $\le 1$.5 * 105
0 <= xi < n
1 <= yi $\le 5$ * 104
