...
- **LeetCode**：[#2921 Maximum Profitable Triplets With Increasing Prices Ii](https://leetcode.com/problems/maximum-profitable-triplets-with-increasing-prices-ii/)
- **难度**：Hard
...
3 $\le \mathrm{len}(prices)$ == profits.length $\le 50000$
1 <= prices[i] $\le 5000$
1 <= profits[i] $\le 106$
