...
- **LeetCode**：[#2479 Maximum Xor Of Two Non Overlapping Subtrees](https://leetcode.com/problems/maximum-xor-of-two-non-overlapping-subtrees/)
- **难度**：Hard
- **标签**：Tree · Depth-First Search · Graph · Trie
