...
- **LeetCode**：[#2489 Number Of Substrings With Fixed Ratio](https://leetcode.com/problems/number-of-substrings-with-fixed-ratio/)
- **难度**：Medium
- **标签**：Hash Table · Math · String · Prefix Sum
