...
- **LeetCode**：[#3279 Maximum Total Area Occupied By Pistons](https://leetcode.com/problems/maximum-total-area-occupied-by-pistons/)
- **难度**：Hard
- **标签**：Array · Hash Table · String · Counting · Prefix Sum · Simulation
...
1 <= height $\le 106$
1 $\le \mathrm{len}(positions)$ == directions.length $\le 105$
