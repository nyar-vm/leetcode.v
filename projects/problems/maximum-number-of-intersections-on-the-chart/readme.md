...
- **LeetCode**：[#3009 Maximum Number Of Intersections On The Chart](https://leetcode.com/problems/maximum-number-of-intersections-on-the-chart/)
- **难度**：Hard
- **标签**：Binary Indexed Tree · Geometry · Array · Math
