...
- **LeetCode**：[#3032 Count Numbers With Unique Digits Ii](https://leetcode.com/problems/count-numbers-with-unique-digits-ii/)
- **难度**：Easy
- **标签**：Hash Table · Math · Dynamic Programming
