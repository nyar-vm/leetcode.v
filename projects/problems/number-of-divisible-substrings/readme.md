...
- **LeetCode**：[#2950 Number Of Divisible Substrings](https://leetcode.com/problems/number-of-divisible-substrings/)
- **难度**：Medium
- **标签**：Hash Table · String · Counting · Prefix Sum
