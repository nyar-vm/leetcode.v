...
- **LeetCode**：[#2907 Maximum Profitable Triplets With Increasing Prices I](https://leetcode.com/problems/maximum-profitable-triplets-with-increasing-prices-i/)
- **难度**：Medium
...
3 $\le \mathrm{len}(prices)$ == profits.length $\le 2000$
1 <= prices[i] $\le 106$
1 <= profits[i] $\le 106$
