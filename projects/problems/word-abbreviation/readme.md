...
- **LeetCode**：[#527 Word Abbreviation](https://leetcode.com/problems/word-abbreviation/)
- **难度**：Hard
- **标签**：Greedy · Trie · Array · String · Sorting
...
1 $\le \mathrm{len}(words)$ $\le 400$
2 <= words[i].length $\le 400$
