...
- **LeetCode**：[#3004 Maximum Subtree Of The Same Color](https://leetcode.com/problems/maximum-subtree-of-the-same-color/)
- **难度**：Medium
- **标签**：Tree · Depth-First Search · Array · Dynamic Programming
