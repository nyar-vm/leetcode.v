...
- **LeetCode**：[#2792 Count Nodes That Are Great Enough](https://leetcode.com/problems/count-nodes-that-are-great-enough/)
- **难度**：Hard
- **标签**：Tree · Depth-First Search · Divide and Conquer · Binary Tree
