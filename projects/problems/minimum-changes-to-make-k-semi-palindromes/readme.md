...
- **LeetCode**：[#2911 Minimum Changes To Make K Semi Palindromes](https://leetcode.com/problems/minimum-changes-to-make-k-semi-palindromes/)
- **难度**：Hard
...
2 $\le \mathrm{len}(s)$ $\le 200$
1 <= k $\le \mathrm{len}(s)$ / 2
