...
- **LeetCode**：[#3104 Find Longest Self Contained Substring](https://leetcode.com/problems/find-longest-self-contained-substring/)
- **难度**：Hard
- **标签**：Hash Table · String · Binary Search · Prefix Sum
