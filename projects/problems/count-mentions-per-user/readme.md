...
- **LeetCode**：[#3433 Count Mentions Per User](https://leetcode.com/problems/count-mentions-per-user/)
- **难度**：Medium
- **标签**：Array · Math · Sorting · Simulation
...
1 <= numberOfUsers $\le 100$
1 $\le \mathrm{len}(events)$ $\le 100$
events[i].length == 3
events[i][0] will be one of MESSAGE or OFFLINE.
1 <= int(events[i][1]) $\le 105$
