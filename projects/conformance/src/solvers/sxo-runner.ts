...
import type { TestCase } from "../core/metadata.ts";
import { createMatlabEvaluator, createWolframEvaluator } from "../runner/sxo-bridge.ts";
import { parseMatlabSurface, parseWolframSurface } from "../runner/sxo-json.ts";
import {
    buildMatlabProgram,
    buildWolframProgram,
    loadSxoSolverBundle,
